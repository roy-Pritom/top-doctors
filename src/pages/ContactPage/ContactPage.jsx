    ...
    return (
        <div>
            <div className="md:text-5xl text-2xl font-semibold text-[#2F2F2F] flex justify-center">
                ...
                <p className='-ml-7'>us</p>
            </div>

            <div className="md:mt-14 flex justify-center items-center md:gap-20">
                <img src="https://s3-alpha-sig.figma.com/img/e4b9/3ace/226c3e1f7a8f3824955999d207f510fc?Expires=1692576000&Signature=JAMhBDNpsKxcFk8lMpCxU6Sm9dQfcDVXPADzdTr-C~sFSbHGYRmsmCFALJdIfwd6sihA3P2JkUyH-KfGLyRHoFe9f8h2t8hkZJ8HH4pq2l7fQfYsYV-iuBS7WKT2y7TFqAwqDjFGJcBg-p8DKZdEW-ar5Wxhef0b~7~n6DPA8xhrYQi7a9aqKlmZc5ev82lKdM69l7umfJloE7S879k7UBV-Hp-d51-tYqcw1iX-dq9ArHMRcmZK9Ma0ZXuU-kX5G0FA2JBD9AIw4imyRuO~8LbHPxhq1I0emCscKdZXXg5LhlgHBc4yejaHNUrsJwY1k1pn~qT3nrx0sMhMPMUZFQ__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" className="md:w-[470px] h-[339px] w-full  " id="contact-img" alt="" />
                <div className="">
                <div className="relative flex  items-center md:gap-7">
                    
                    <img src={circleIcon}  className='' alt="" />
                    <img src={personIcon}  className='absolute md:top-[24px] md:left-[30px]' alt="" />
                    
                    <input type="text" placeholder="Full Name" className="input input-bordered md:w-[600px]  max-w-xs " />
                </div>
                <div className="relative flex  items-center md:gap-7">
                    
                    <img src={circleIcon}  className='' alt="" />
                    <img src={mailIcon}  className='absolute md:top-[24px] md:left-[30px]' alt="" />
                    
                    <input type="text" placeholder="Email" className="input input-bordered md:w-[600px]  max-w-xs " />
                </div>
                <div className="relative flex  items-center md:gap-7">
                    
                    <img src={circleIcon}  className='' alt="" />
                    <img src={callIcon}  className='absolute md:top-[24px] md:left-[30px]' alt="" />
                    
                    <input type="text" placeholder="Phone number" className="input input-bordered md:w-[600px]  max-w-xs " />
                </div>
                <button className='btn  capitalize bg-[#008DD9] rounded-[10px] text-white text-xl font-medium w-[180px] h-[50px] md:ml-[270px]'>Submit</button>
                </div>
