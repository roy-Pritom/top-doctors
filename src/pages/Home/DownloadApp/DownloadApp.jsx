...
const DownloadApp = () => {
    return (
        <div className="relative md:mt-20 mt-12">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className='w-full h-[800px]'  fill="none">
            ...
            <div className="absolute md:top-[100px] ">


                <div className="flex items-center justify-center gap-14 md:ml-48">
                    ...
                    <div className="md:mt-60">
                        <div className="">
                            <input type="text" placeholder='+91 |' className='pl-8 search lg:w-[600px] lg:h-[75px] text-black text-2xl font-semibold' />
                            <div className="bg-[#138ED1] md:w-[80px] md:h-[75px] flex justify-center items-center absolute right-0 md:bottom-[240px] cursor-pointer">
                                <img src={callIcon} alt="" className='' />
                            </div>

                        </div>
                        <div className="flex items-center md:gap-5 mt-12">
                            <button className="btn btn-lg bg-[#333] text-white text-xl font-semibold">
