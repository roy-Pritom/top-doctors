...
const TopDoctors = () => {
    return (
        <div className='mt-24 md:mt-0'>
            <h3 className="text-center lg:text-5xl text-3xl font-semibold">Take a look at our list of <span className="text-[#138ED1]">specialized</span><br /> doctors</h3>
            ...
            <div className="flex md:flex-row flex-col justify-center items-center lg:gap-16 
            md:gap-4 gap-28 md:mt-16 mt-12 px-5 lg:px-0">

                <div className="w-[353px] h-[390px] lg:w-[353px] lg:h-[390px] md:w-full search pl-8 pt-6  relative">
                ...
                <div className="w-[353px] h-[390px] lg:w-[353px] lg:h-[390px] md:w-full search pl-8 pt-6  relative">
                    <p className="text-[28px] font-semibold">Dr. Diptesh <span className='hidden lg:block'>Kumar</span></p>
                    <button className="btn btn-sm bg-[#138ED1] text-sm text-white capitalize rounded-2xl mt-3">Cardiologist</button>
                    <div className="flex gap-1 items-center mt-3">
                        <p className='text-xl font-semibold'>4.3</p>
                        <img src={ratingLogo} alt="" />
            ...
            <div className="flex justify-center items-center gap-4 lg:mt-[125px] mt-[80px]">
