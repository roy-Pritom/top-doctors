...
const AskQuestion = () => {
    return (
        <div className="md:mt-52 mb-[96px]">
            ...
            <div className="md:text-5xl text-2xl font-semibold text-[#2F2F2F] flex justify-center ">
              ...
              <p className='-ml-5'>asked </p>
          </div>

          <div className="md:ml-24 mt-9 md:w-[480px] md:h-[90px] question-box flex items-center pl-5">
             <p className="text-lg font-semibold">Can I book an appointment on behalf of <br /> someone else?</p>
          </div>
          <div className="md:ml-24 mt-[18px] md:w-[480px] md:h-[90px] question-box flex items-center pl-5">
